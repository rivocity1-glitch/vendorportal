    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F0FDF4] via-white to-[#EFF6FF] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-black/5 border border-[#E2E8F0] p-8">
          {forgotMode ? (
            ...
            <>
              ...
              {/* Relocated Register Button Element */}
              <button
                type="button"
              ...
              <div className="mt-6 pt-6 border-t border-[#E2E8F0]">
                <p className="text-xs text-center text-[#94A3B8]">
                  Demo credentials: <span className="font-mono text-[#64748B]">SHOP-001</span> / <span className="font-mono text-[#64748B]">password</span>
                </p>
              </div>
            </>
          )}
        ...
        <p className="text-center text-xs text-[#94A3B8] mt-6">
          Everything Nearby. Delivered Fast. · <span className="text-[#10B981]">Rivo</span> © 2024
        </p>
      </div>
    </div>
  );
